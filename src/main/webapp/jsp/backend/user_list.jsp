...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">会员列表</h2>
            <a  id="addUser" class="fr top_rt_btn add_icon">添加定制师</a>
        </div>
        <section class="mtb">
    ...
    $('#addUser').click(function () {
        layui.use('layer', function () {
            layer.open({
                ...
                shade: 0.8,
                area: ['600px', '700px'],
                content: 'http://localhost:8080/jsp/backend/addUser.html'
            });
        });
    })
    function del(obj) {
        ...
        if(confirm("确实要删除吗？")){
            $.ajax({
                type:"POST",
                url:"http://localhost:8080/managerUser/delete",
                data:{
                    id:id
                },
                dataType:"json",
...
<script>
    ...
    function init(){
        $.ajax({
            url:"http://localhost:8080/managerUser/count",
            async: false,
            type:"get",
            dataType:"json",
            success:function(data){
                ...
                $.jqPaginator('#pagination', {
                    ...
                    onPageChange: function (pageIndex) {
                        ...
                        $.ajax({
                            url:"http://localhost:8080/managerUser/list",
                            async: false,
                            data:{
                                current:pageIndex,
                                size:5
                            ...
                            success:function(result){
                                ...
                                $.each(data.records,function(i,item){
                                    var edtior="<td class='center'><a href='http://localhost:8080/managerUser/updateView/"+item.id+"' title='编辑' class='link_icon'>&#101;</a><a  title='删除' class='link_icon'value='"+item.id+"' onclick='del(this)'>&#100;</a> </td>";
                                    showTableHtml += "<tr>"+
