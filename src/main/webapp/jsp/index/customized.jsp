                ...
                <form method="post" name="travel-cus" class="cusForm" onsubmit="false">
                    ...
                    <ul class="cus-table">
                        ...
                        <li>
                            <label>出发人数：</label>
                            <div class="cus-man-btn">
                                <span class="cus-nextPer">-</span>
                                <input type="text" value="1" name="number" class="cus-perNum"/>
                                <span class="cus-prevPer">+</span>
                                人
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <label>  QQ：</label>
                            <input type="text" class="qq" id="qq" name="qq" placeholder="请输入QQ">
                        </li>
                        <li>
                            <label>  备注：</label>
...
<script>
    ...
    //                 str = str +"<li><a href='http://wpa.qq.com/msgrd?v=3&uin=" + item.qq + "&site=qq&menu=yes' target='_blank'>"+"<cite>"+item.areaName+"("+item.username+")"+"</cite></a></li>"
    //             })
    //             console.log(str)
    //             str = str +"</ul>";
    //         }
...
//  减少天数
        ...
        //增加天数
        $(".cus-prevPer").on("click",function(){
            var mun=parseInt($(this).parent().find(".cus-perNum").val());
            if(isNaN(mun))
                mun=0;
            mun++;
            $(this).prev().val(mun);
            $(this).prev().change();
            var con = $(".cus-perNum").attr("name");
                $("#perantNum").text(mun);
        });
//  减少天数
        $(".cus-nextPer").on("click",function(){
            var mun=parseInt($(this).parent().find(".cus-perNum").val());
            if(isNaN(mun))
                mun=2;
            mun--;
        ...
        $(".remark").on("change",function(){
            if(type == 3)
                ...
                $(this).parents("form").next().find("span").eq(10).text($(this).val());
        });
        //备注
        //备注
