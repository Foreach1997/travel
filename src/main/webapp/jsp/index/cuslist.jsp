            ...
            <c:forEach items="${customizations}" var="item" >
                <div class="n_order_info clear">
                    ...
                    <div class="n_user_operation">
                        ...
                        <c:if test="${item.custStatus == 0}">
                        <a   class="n_btn_normal n_btn_warn" value="${item.id}" onclick="levelMsg(this)">留言</a>
                        </c:if>
    ...
    function levelMsg(data){
        ...
        layui.use('layer', function () {
            layer.open({
                ...
                shade: 0.8,
                area: ['1026px', '220px'],
                content: 'http://localhost:8080/jsp/index/addInfo.html'
            });
        });
    }
</script>