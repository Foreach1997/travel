            ...
            <form class="edit_user_form" method="post" action="/User/editcustomdemand/id/801" style="padding-top:0;">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="user_form_input">
                            <input type="text" id="areaName" class="user_inputxt" name="aim_place" datatype="s2-16" nullmsg="请输入目的地！" errormsg="目的地至少2个字符,最多16个字符！" value="${cus.endAreaname}" placeholder="例如桂林" maxlength="16" />
                        </td>
                        <td>
                            <div class="Validform_checktip"></div>
                    ...
                    <tr>
                        <td colspan="4" class="form_title_td"><span class="icon_location2"></span>方案</td>
                    </tr>
                    <tr>
                        <td class="need td_w_120"></td>
                        <td class="user_form_input" colspan="2">
                            <textarea class="user_inputxt" disabled style=" min-height:100px; width: 450px" >${cus.customizedInfo}</textarea>
                        </td>
                        <td>
                        </td>
                    </tr>
...
<script>
    ...
    layui.use("layer",function (){
        ...
        //             str = str +"<li><a href='http://wpa.qq.com/msgrd?v=3&uin=" + item.qq + "&site=qq&menu=yes' target='_blank'>"+"<cite>"+item.areaName+"("+item.username+")"+" 个性标签:"+item.personalityLabel+"</cite></a></li>"
        //         })
        //         console.log(str)
        //         str = str +"</ul>";
        //     }
